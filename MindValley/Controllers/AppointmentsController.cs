...
namespace MindValley.Controllers
{
    ...
    public class AppointmentsController : ControllerBase
    {
        ...
        public AppointmentsController(MindValleyContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Appointment>> PostAppointment(Appointment appointment)
        {
            ...
            var therapistExists = await _context.Therapists.AnyAsync(t => t.TherapistId == appointment.TherapistId);
            if (!therapistExists)
            {
                return BadRequest("Therapist not found.");
            }

            // Ajouter le rendez-vous sans inclure les objets User et Therapist
            _context.Appointments.Add(appointment);
            await _context.SaveChangesAsync();
